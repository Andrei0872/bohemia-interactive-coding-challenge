          ...
          <li className="relative" key={p.name}>
            ...
            <div className="group">
              <div className="relative w-[282px] h-[450px]">
                ...
                <button onClick={() => addProductToCart(p)} className="hidden group-hover:block absolute uppercase bottom-0 left-0 right-0 bg-[#000] text-[#fff] pt-1 pb-1">Add to cart</button>
              </div>
